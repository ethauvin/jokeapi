...
dependencies {
    implementation("net.thauvin.erik:jokeapi:1.0.1")
}
```
...
See [CONTIBUTING.md](https://github.com/ethauvin/jokeapi?tab=contributing-ov-file#readme) for information about
